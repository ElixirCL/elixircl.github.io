...
Nuestro Telegram Oficial es https://t.me/elixircl[ElixirCL].

## Comunidades Amigas

### https://elixir-slackin.herokuapp.com/[Elixir Oficial]

El canal oficial de _Elixir_.

### https://join.slack.com/t/elixirjp/shared_invite/zt-ae8m5bad-WW69GH1w4iuafm1tKNgd~w[Elixir Japan]

El canal de https://elixirjp.slack.com/archives/C01JMMZM0SH[`#autoraceex`] es un buen canal para compartir
el amor por _Elixir_.

### https://devschile.cl/[Devs Chile]

Comunidad de devs chilenos.
